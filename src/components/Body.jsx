  ...
  return (
    <div className="content">
      ...
      <p className="content-introduction">
        ...
        diving into both front-end and back-end development, and I enjoy working
        with technologies like <span class="content-skills">HTML</span>,{" "}
        ...
        <span class="content-skills">PostgreSQL</span>, and I'm always eager to
