  ...
  return (
    <body>
      <div className="content">
        <h1 className="content-greet">NOR AIMAN AKASHAH BIN AHMAD!</h1>
        <p className="content-introduction">
          I'm {/* <span className="content-name"> Nor Aiman Akashah</span>,  */}{" "}
          an aspiring web developer based in Kedah, Malaysia with a passion for
          creating dynamic and user-friendly websites. A recent graduate from
          <a
          ...
          , I'm excited to embark on my journey in the tech industry.
          <br />
          <br />I love diving into both front-end and back-end development, and
